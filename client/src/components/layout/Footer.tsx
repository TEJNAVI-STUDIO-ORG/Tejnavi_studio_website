                ...
                >
                  {openDoc === "privacy" ? (
                    <div className="space-y-6">
                      <p>
                        This Privacy Policy explains how Tejnavi Studio (the “Website”) collects, uses, and protects
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p>
                          The Website is provided “as is” and “as available” without warranties of any kind. We do not
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-ashGrey">
              ...
              <li><Link href="/projects"><a className="hover:text-whiteChrome transition-colors">Projects</a></Link></li>
              <li><Link href="/about-us"><a className="hover:text-whiteChrome transition-colors">About Us</a></Link></li>
